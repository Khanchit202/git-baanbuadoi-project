    ...
    ?>    
        <div class="dropdown" style="position: relative; display: inline-block;">
            ...
            <div class="dropdown-menu"
                ...
                <a href="./user_history.php" style="display: block; padding: 10px; text-decoration: none; color: #333;">
...
function admin_menu($profile_name) {
    ...
    ?>    
        ...
        <div class="con"></div>
        <div onclick="goToDashboard()" class="me-2" style="width: 40px; height: 40px; border-radius: 50%; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color: #f0f0f0; border: 2px solid #ddd; cursor: pointer;">
