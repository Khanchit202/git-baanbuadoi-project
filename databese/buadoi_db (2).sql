...
(00008, 300.00, 'ห้องเดียว', 'ห้องเดียว', 1, 1, 'ห้องเดียว', 'room1.jpg', 1, 1, 00002),
...
(00016, 'khanchit', '$2y$10$iOM62xwurLEpRzCZ.L11f.O14MOL7KiG1isUcgd8iRACaedj4x0ka', 'ครรชิต', 'บางพระ', '0958053137', 'khanchit202@gmail.com', 4, 'img/profile/profile_1.jpg'),
(00017, 'admin1', '$2y$10$ZzwsNBiaxc9VL9gdNHE5H.OxkjPvLFMi3bUgD0003hof6No0M8EB.', 'สมชาย', 'หมั่นเฮิง', '0830026319', 'lakwazap@gmail.com', 4, 'img/profile/profile_1.jpg');
...
--
ALTER TABLE `users`
  MODIFY `userID` smallint(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
