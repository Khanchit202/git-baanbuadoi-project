...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <?php
            $currentDateTime8 = date('Y-m-d H:i:s');

            $sql8 = "INSERT INTO statistic (coundTime) VALUES (:visit_time)";
            $stmt8 = $db_con->prepare($sql8);
            $stmt8->bindParam(':visit_time', $currentDateTime8);
            $stmt8->execute();
        ?>
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-end" style="color: #000;">
                            <div class="overlay-content p-4" style="background: rgba(255, 255, 255, 0.9); border-radius: 10px; transition: transform 0.3s;">
                                ...
                                <div class="d-flex justify-content-between align-items-center" style="font-size: 12px;">
                                    ...
                                    <p class="card-text text-right font-weight-bold" style="font-size: 16px; font-weight: bold;"><?php echo number_format($room['roomPrice']); ?>฿</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wow fadeInUp" data-wow-delay="0.5s" style="margin: 30px;">
                    <div class="card position-relative text-white card-hover mb-5" style="width: 250px; height: 300px; overflow: hidden; position: relative; border-radius: 5px;">
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-end" style="color: #000;">
                            <div class="overlay-content p-4" style="background: rgba(255, 255, 255, 0.9); border-radius: 10px; transition: transform 0.3s;">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h5 class="card-title m-0" style="font-size: 14px;"><?php echo number_format($service['serviceName']); ?></h5>
                                    <p class="m-0">★ </p>
                                </div>
                                <div class="d-flex justify-content-between align-items-center" style="font-size: 12px;">
