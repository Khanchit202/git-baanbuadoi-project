            ...
            <div class="container">
                ...
                <div class="row mt-5" style="display: flex; justify-content: space-between;">
                    <div class="col-md-5 py-2"style="width:50%;">
                        <p style="font-weight:bold">รายได้เดือน : <?php echo $mout; ?></p>
                        
                            <div class="card-body"style="display: flex; justify-content: center;">
                                    <div class="circleDiv">
                                        <div class="circleDivinside">
                                            <p style="font-weight:bold;font-size:50px;color: #7FFF00">฿<?php echo $totalPayManey; ?></p>
                                        </div>
                                    </div>
                            </div>
                                <div class="col-md-2 green-boxs " style=" border-left: solid 4px #72d572;">
                                    <div class="row center-text mt-2">
                                        <p style="font-size: 14px;">เดือนที่ผ่านมา <?php echo $previousMonth; ?></p>
                                    </div>
                                    <div class="row">
                                        <p style='font-size: 18px;'>฿<?php echo $totalPayManeys; ?> </p>
                                    </div>
                                </div>
                    </div>
                    <div class="col-md-5 py-2"style="width:50%;">
                    <p style="font-weight:bold">รายได้ปี : <?php echo $yeas; ?></p>
                        
                            <div class="card-body"style="display: flex; justify-content: center;">
                                <div class="circleDiv">
                                    <div class="circleDivinside">
                                        <p style="font-weight:bold;font-size:50px;color: #7FFF00">฿<?php echo $totalPayManeyyear; ?></p>
                            ...
                            <div class="col-md-2 green-boxs " style=" border-left: solid 4px #72d572;">
                                    <div class="row center-text mt-2">
                                        <p style="font-size: 14px;">ปีที่ผ่านมา <?php echo $previousYear; ?></p>
                                    </div>
                                    <div class="row">
                                        <p style='font-size: 18px;'>฿<?php echo $totalPayManeyyeas; ?> </p>
                                    </div>
                                </div>
                    </div>
