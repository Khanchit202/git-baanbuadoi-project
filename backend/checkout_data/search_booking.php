    ...
    <div class="modal-dialog" style="max-width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="#" class="btn me-1 " style="font-size: 14px; background-color: #4caf50; color: #ffffff; background-color: none; border-radius: 5px;" onclick="checkoutHandler('<?php echo htmlspecialchars($row['billID']); ?>')">Check Out</a>
            </div>
        </div>
    </div>
</div>
