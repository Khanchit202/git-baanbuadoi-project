<!-- Footer Start -->
    <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5 wow fadeIn " data-wow-delay="0.1s" style="background-color: #3e3e3e; color: #ccc; padding: 40px 0;">
        <div class="container py-5">
            <div class="row mx-auto">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>ดอยอ่างขาง บ้านนอแล จังหวัดเชียงใหม่</p>
            ...
            <div class="text-center mt-5">
                <p>ออกแบบและพัฒนาโดย นายครรชิต บางพระ และนายสมชาย หนังเฮิง หลักสูตรระบบสารสนเทศทางธุรกิจ-พัฒนาซอฟต์แวร์ มหาวิทยาลัยเทคโนโลยีราชมงคลล้านนา</p>
            </div>
        </div>  
<!-- Footer End -->
...
<!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-custom btn-lg-square back-to-top" style="display: block; position: fixed; bottom: 20px; left: 20px; z-index: 999;">
