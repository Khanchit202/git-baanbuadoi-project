                            ...
                            <div class="testimonial-content d-flex flex-column"style="width: 80%;">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="star-rating" style="font-size: 12px;">
                                        ...
                                        <p class="mb-0" style="font-size: 8px; opacity: 60%;"><?php echo htmlspecialchars(thai_date($review['rvsDate'])); ?></p>
                                    </div>
                                    <div class="star-rating" style="font-size: 12px; color: #BC5686;">
                                        <?php
                                        $rating = $review['rvsScore'];
                                        for ($i = 0; $i < 5; $i++) {
                                            if ($i < $rating) {
                                ...
                                <p style="width: 90%; font-size: 10px;"><?php echo htmlspecialchars($review['rvsDetail']); ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
